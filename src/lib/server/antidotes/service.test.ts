...
import type { CuratedReflectionCandidate, Diagnosis, SelectedReflection } from '@/lib/shared/antidotes/types';
...
function toStructuredOpenAICaller(mock: ReturnType<typeof createStructuredOpenAIMock>) {
  return mock as unknown as typeof import('@/lib/server/openai/client').callStructuredOpenAI;
}
