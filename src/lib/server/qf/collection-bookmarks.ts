import { parseAyahSelection } from '@/lib/shared/quran/ayah';
...
import { logBookmarkPayloadDebug, qfApiFetch } from '@/lib/server/qf/client';
import { isQfAuthDebugEnabled, qfAuthDebug } from '@/lib/server/qf/config';
import { ensureVerseCollection, getExistingVerseCollection } from '@/lib/server/qf/collections-api';
import { getQfUserSession } from '@/lib/server/qf/session';
import type { QfAyahBookmark, QfBookmark, QfPagination } from '@/lib/shared/qf/types';
